...
impl From<&PlayerOverview> for Player {
    fn from(player: &PlayerOverview) -> Self {
        Self {
            ...
            chance_of_playing_next_round: player.chance_of_playing_next_round.map(|v| v as i16),
            chance_of_playing_this_round: player.chance_of_playing_this_round.map(|v| v as i16),
            code: player.code as i32,
            cost_change_event: player.cost_change_event as i16,
            cost_change_event_fall: player.cost_change_event_fall as i16,
            cost_change_start: player.cost_change_start as i16,
            cost_change_start_fall: player.cost_change_start_fall as i16,
            dreamteam_count: player.dreamteam_count as i16,
            element_type: player.element_type as i16,
            ...
            transfers_in: player.transfers_in as i32,
            transfers_in_event: player.transfers_in_event as i32,
            transfers_out: player.transfers_out as i32,
            ...
            goals_scored: player.goals_scored as i16,
            assists: player.assists as i16,
            clean_sheets: player.clean_sheets as i16,
            goals_conceded: player.goals_conceded as i16,
            own_goals: player.own_goals as i16,
            penalties_saved: player.penalties_saved as i16,
            penalties_missed: player.penalties_missed as i16,
            yellow_cards: player.yellow_cards as i16,
            red_cards: player.red_cards as i16,
            saves: player.saves as i16,
            bonus: player.bonus as i16,
            bps: player.bps,
            influence: player.influence,
            creativity: player.creativity,
            threat: player.threat,
            ict_index: player.ict_index,
            starts: player.starts as i16,
            ...
            influence_rank: player.influence_rank as i16,
            influence_rank_type: player.influence_rank_type as i16,
            creativity_rank: player.creativity_rank as i16,
            creativity_rank_type: player.creativity_rank_type as i16,
            threat_rank: player.threat_rank as i16,
            threat_rank_type: player.threat_rank_type as i16,
            ict_index_rank: player.ict_index_rank as i16,
            ict_index_rank_type: player.ict_index_rank_type as i16,
            ...
            now_cost_rank: player.now_cost_rank as i16,
            now_cost_rank_type: player.now_cost_rank_type as i16,
            form_rank: player.form_rank as i16,
            form_rank_type: player.form_rank_type as i16,
            points_per_game_rank: player.points_per_game_rank as i16,
            points_per_game_rank_type: player.points_per_game_rank_type as i16,
            selected_rank: player.selected_rank as i16,
