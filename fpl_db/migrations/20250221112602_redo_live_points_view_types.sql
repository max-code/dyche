...
bonus_summary AS (
    SELECT b.player_id, SUM(b.bonus)::BIGINT AS total_bonus
    FROM bonus b
...
SELECT
    ...
    SUM(tgwp.multiplier * (gwp.total_points + COALESCE(bs.total_bonus, 0) - gwp.bonus))::BIGINT AS calculated_week_points,
    ...
    (t.summary_overall_points 
     ...
     - t.summary_event_points)::BIGINT AS calculated_overall_points
